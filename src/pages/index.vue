          ...
          <ul class="menu-wrap">
            ...
            <li class="menu-item">
              <a href="javascript:;">电视 盒子</a>
               <div class="children">电视 盒子</div>
            </li>
            <li class="menu-item">
              <a href="javascript:;">笔记本 平板</a>
               <div class="children">笔记本 平板</div>
            </li>
            <li class="menu-item">
              <a href="javascript:;">家电 插线板</a>
               <div class="children">家电 插线板</div>
            </li>
            <li class="menu-item">
              <a href="javascript:;">出行 穿戴</a>
               <div class="children">出行 穿戴</div>
            </li>
            <li class="menu-item">
              <a href="javascript:;">智能 路由器</a>
               <div class="children">智能 路由器</div>
            </li>
            <li class="menu-item">
              <a href="javascript:;">电源 配件</a>
               <div class="children">电源 配件</div>
            </li>
            <li class="menu-item">
              <a href="javascript:;">生活 箱包</a>
               <div class="children">生活 箱包</div>
            </li>
          </ul>
        </div>
